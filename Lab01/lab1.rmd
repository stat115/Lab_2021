...
- Click on the Lab_2021 repository Lab 1 repository

- Click the "Clone or download" button.
    - If you have git installed, you can copy the link, then go to your terminal command line and type git clone https://github.com/stat115/Lab_2021.git
    - You could also click Download Zip and open in finder/explorer. Open lab1.rmd in RStudio.
    - Alternatively, copy the URL to the clipboard (https://github.com/stat115/Lab_2021.git). Switch to RStudio. Click the "Project (None)" button in the near the top menu bar. Click "New Project", "Version Control", "Git", then paste the URL into the first box.
